...
L_8007F1C0:
    ...
    MEM_W(0X10, ctx->r29) = 0;
    LOOKUP_FUNC(0x800EC588)(rdram, ctx);
        goto after_16;
    // 0x8007F1F4: sw          $zero, 0x10($sp)
    MEM_W(0X10, ctx->r29) = 0;
    after_16:
    ...
    LOOKUP_FUNC(0x800F947C)(rdram, ctx);
        goto after_20;
    // 0x8007F258: addu        $a1, $v0, $zero
    ctx->r5 = ADD32(ctx->r2, 0);
    after_20:
    ...
    LOOKUP_FUNC(0x800F97F4)(rdram, ctx);
        goto after_21;
    // 0x8007F26C: nop
    ...
    ctx->r6 = ADD32(0, 0);
    LOOKUP_FUNC(0x800F9AF4)(rdram, ctx);
        goto after_22;
    // 0x8007F27C: addu        $a2, $zero, $zero
    ctx->r6 = ADD32(0, 0);
    after_22:
...
L_8007F3F0:
    ...
    LOOKUP_FUNC(0x800F20EC)(rdram, ctx);
        goto after_32;
    // 0x8007F3F8: nop
    ...
    ctx->r7 = ADD32(0, 0);
    LOOKUP_FUNC(0x800F1E7C)(rdram, ctx);
        goto after_33;
    // 0x8007F418: addu        $a3, $zero, $zero
    ctx->r7 = ADD32(0, 0);
    after_33:
    ...
    ctx->r4 = ADD32(ctx->r19, 0X38);
    LOOKUP_FUNC(0x800EC684)(rdram, ctx);
        goto after_34;
    // 0x8007F420: addiu       $a0, $s3, 0x38
    ctx->r4 = ADD32(ctx->r19, 0X38);
    after_34:
...
L_8007F478:
    ...
    LOOKUP_FUNC(0x800F9A14)(rdram, ctx);
        goto after_38;
    // 0x8007F498: nop
...
L_8007F540:
    ...
    MEM_W(0X60, ctx->r29) = ctx->f0.u32l;
    LOOKUP_FUNC(0x800B40F0)(rdram, ctx);
        goto after_50;
    // 0x8007F6C8: swc1        $f0, 0x60($sp)
    MEM_W(0X60, ctx->r29) = ctx->f0.u32l;
    after_50:
...
L_8007F8F4:
    ...
    LOOKUP_FUNC(0x800EC6C0)(rdram, ctx);
        goto after_68;
    // 0x8007F8FC: nop
...
L_8007FA34:
    ...
    vec3ExtrapolateFirstOrder(rdram, ctx);
        goto after_77;
    // 0x8007FA48: addu        $a2, $s0, $zero
    ctx->r6 = ADD32(ctx->r16, 0);
    after_77:
...
L_8007FB54:
    ...
    spawnHeavyMechSubEffect(rdram, ctx);
        goto after_85;
    // 0x8007FC08: swc1        $f6, 0xC0($sp)
    MEM_W(0XC0, ctx->r29) = ctx->f6.u32l;
    after_85:
...
L_8007FF1C:
    ...
    LOOKUP_FUNC(0x800F9AB8)(rdram, ctx);
        goto after_100;
    // 0x8007FF40: nop
...
L_8008006C:
    ...
    ctx->r5 = ADD32(ctx->r20, 0);
    LOOKUP_FUNC(0x800EFD80)(rdram, ctx);
        goto after_103;
    // 0x80080074: addu        $a1, $s4, $zero
    ctx->r5 = ADD32(ctx->r20, 0);
    after_103:
...
L_8008007C:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X148);
;}
RECOMP_FUNC void attachedAudioVisualEmitterNpcHandler(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800804E8:
    ...
    ctx->r16 = ADD32(0, 0);
    LOOKUP_FUNC(0x800EFDE0)(rdram, ctx);
        goto after_21;
    // 0x80080500: addu        $s0, $zero, $zero
    ctx->r16 = ADD32(0, 0);
    after_21:
    ...
    LOOKUP_FUNC(0x800F06BC)(rdram, ctx);
        goto after_23;
    // 0x80080518: nop
...
L_80080538:
    ...
    LOOKUP_FUNC(0x800F07AC)(rdram, ctx);
        goto after_28;
    // 0x800805A4: nop
...
L_800805F4:
    ...
    ctx->r7 = ADD32(0, 0);
    LOOKUP_FUNC(0x800F2D38)(rdram, ctx);
        goto after_29;
    // 0x80080608: addu        $a3, $zero, $zero
    ctx->r7 = ADD32(0, 0);
    after_29:
...
L_800811EC:
    ...
    LOOKUP_FUNC(0x800F2120)(rdram, ctx);
        goto after_92;
    // 0x80081250: nop
    ...
    LOOKUP_FUNC(0x800F2A24)(rdram, ctx);
        goto after_97;
    // 0x800812CC: nop
...
L_80081A84:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X1B0);
;}
RECOMP_FUNC void npcVortexUpdate(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_8008202C:
    ...
    spawnRandomScaleColoredEffectAltVariant(rdram, ctx);
        goto after_24;
    // 0x80082044: nop
...
RECOMP_FUNC void func_800820F0(uint8_t* rdram, recomp_context* ctx) {
    ...
    LOOKUP_FUNC(0x800F2070)(rdram, ctx);
        goto after_0;
    // 0x8008211C: addu        $s1, $a2, $zero
    ctx->r17 = ADD32(ctx->r6, 0);
    after_0:
    ...
    LOOKUP_FUNC(0x800F2830)(rdram, ctx);
        goto after_3;
    // 0x80082200: nop
...
RECOMP_FUNC void fake_func_80082268(uint8_t* rdram, recomp_context* ctx) {
    ...
    int c1cs = 0;
;}
RECOMP_FUNC void applyCheatCodeFromInput(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_8008258C:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void noopHandler_800825C0(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    // 0x800825C0: jr          $ra
    // 0x800825C4: nop
...
RECOMP_FUNC void fake_func_800825C8(uint8_t* rdram, recomp_context* ctx) {
    ...
    int c1cs = 0;
;}
RECOMP_FUNC void findModelAnimKeyframeByPhase(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void resetModelAnimSlotTable(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80082878:
    ...
    ctx->r2 = ADD32(0, 0X1);
;}
RECOMP_FUNC void allocateModelAnimSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void appendAnimHandleAndDescendantsToBuffer(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    appendAnimHandleAndDescendantsToBuffer(rdram, ctx);
        goto after_0;
    // 0x80082AD4: nop
...
;}
RECOMP_FUNC void flattenAnimTreeAndAllocateSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80082B78:
    ...
    ctx->r6 = ADD32(ctx->r19, 0);
    allocateModelAnimSlot(rdram, ctx);
        goto after_3;
    // 0x80082B80: addu        $a2, $s3, $zero
    ctx->r6 = ADD32(ctx->r19, 0);
    after_3:
...
;}
RECOMP_FUNC void releaseModelAnimSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void markModelAnimChannelEntryActive(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80082E98:
    ...
    ctx->r2 = ADD32(ctx->r7, 0);
;}
RECOMP_FUNC void clearModelAnimChannelEntry(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void seekModelAnimChannelToTime(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80082FC4:
    ...
    findModelAnimKeyframeByPhase(rdram, ctx);
        goto after_0;
    // 0x80082FF4: addu        $a0, $a3, $zero
    ctx->r4 = ADD32(ctx->r7, 0);
    after_0:
...
;}
RECOMP_FUNC void seekAllModelAnimChannelsInSlotToTime(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void setModelAnimChannelEntryDuration(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void getModelAnimChannelEntryDuration(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void setModelAnimSlotCycleDuration(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void sampleModelAnimKeyframeVec3(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
