...
RECOMP_FUNC void initCinematicSceneAssets(uint8_t* rdram, recomp_context* ctx) {
...
RECOMP_FUNC void hangarGenerateSecondaryWeaponString(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r5 = ctx->r5 & 0XFF;
    LOOKUP_FUNC(0x800C6728)(rdram, ctx);
        goto after_0;
    // 0x800AE5BC: andi        $a1, $a1, 0xFF
    ctx->r5 = ctx->r5 & 0XFF;
    after_0:
...
L_800AE804:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X68);
;}
RECOMP_FUNC void gracefulMenuShutdown(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AE794:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void extractTextBeforeFmtChar(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AE958:
    ...
    MEM_W(0X34, ctx->r6) = ctx->r3;
;}
RECOMP_FUNC void dispatchCinematicFromMainLoop(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AE90C:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void shouldShowCutsceneForLevelStage(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AECC4:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X48);
;}
RECOMP_FUNC void getAssetNameForNpcType(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void initCraftSelectVectors(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void noopHandler_800AEB30(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    // 0x800AEB30: jr          $ra
    // 0x800AEB34: nop
...
;}
RECOMP_FUNC void freeCutsceneResources(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void hangarSetSecondaryWeaponDisplay(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    LOOKUP_FUNC(0x800AE530)(rdram, ctx);
        goto after_0;
    // 0x800AEB64: sw          $s0, 0x18($sp)
    MEM_W(0X18, ctx->r29) = ctx->r16;
    after_0:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X28);
;}
RECOMP_FUNC void resetCutsceneActionSlots(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AEB90:
    ...
    LOOKUP_FUNC(0x800AA4F4)(rdram, ctx);
        goto after_0;
    // 0x800AEBC0: nop
...
;}
RECOMP_FUNC void hangarUpdateSecWeaponIfChanged(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF010:
    ...
    ctx->r17 = ADD32(ctx->r17, 0X1);
    LOOKUP_FUNC(0x800AE7B0)(rdram, ctx);
        goto after_16;
    // 0x800AF018: addiu       $s1, $s1, 0x1
    ctx->r17 = ADD32(ctx->r17, 0X1);
    after_16:
    ...
    ctx->r5 = ADD32(ctx->r4, 0);
    LOOKUP_FUNC(0x800B19EC)(rdram, ctx);
        goto after_34;
    // 0x800AF178: addu        $a1, $a0, $zero
    ctx->r5 = ADD32(ctx->r4, 0);
    after_34:
    ...
    LOOKUP_FUNC(0x800B3AFC)(rdram, ctx);
        goto after_45;
    // 0x800AF29C: sw          $v1, 0x14($sp)
    MEM_W(0X14, ctx->r29) = ctx->r3;
    after_45:
    ...
    LOOKUP_FUNC(0x800B3D08)(rdram, ctx);
        goto after_46;
    // 0x800AF2AC: sw          $a0, -0x2290($v0)
    MEM_W(-0X2290, ctx->r2) = ctx->r4;
    after_46:
...
L_800AF2E8:
    ...
    ctx->r16 = S32(0X800D << 16);
    LOOKUP_FUNC(0x800B1430)(rdram, ctx);
        goto after_47;
    // 0x800AF318: lui         $s0, 0x800D
    ctx->r16 = S32(0X800D << 16);
    after_47:
    ...
    LOOKUP_FUNC(0x800B165C)(rdram, ctx);
        goto after_48;
    // 0x800AF324: lui         $s3, 0x800D
    ctx->r19 = S32(0X800D << 16);
    after_48:
    ...
    ctx->r18 = S32(0X800D << 16);
    LOOKUP_FUNC(0x800B1D54)(rdram, ctx);
        goto after_49;
    // 0x800AF330: lui         $s2, 0x800D
    ctx->r18 = S32(0X800D << 16);
    after_49:
    ...
    LOOKUP_FUNC(0x800B180C)(rdram, ctx);
        goto after_54;
    // 0x800AF384: nop
    ...
    ctx->r4 = ADD32(0, 0X5);
    LOOKUP_FUNC(0x800B3EB8)(rdram, ctx);
        goto after_55;
    // 0x800AF38C: addiu       $a0, $zero, 0x5
    ctx->r4 = ADD32(0, 0X5);
    after_55:
...
L_800AEF30:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X20);
;}
RECOMP_FUNC void tickCutsceneNpcSlots(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AEE74:
    ...
    ctx->r4 = ADD32(ctx->r16, 0);
    getNextSlotNpcTypeId(rdram, ctx);
        goto after_0;
    // 0x800AEE8C: addu        $a0, $s0, $zero
    ctx->r4 = ADD32(ctx->r16, 0);
    after_0:
...
RECOMP_FUNC void func_800AEF30(uint8_t* rdram, recomp_context* ctx) {
    ...
    destroyNpcSlotByIndexU16(rdram, ctx);
        goto after_1;
    // 0x800AEF94: nop
...
L_800AF03C:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X30);
;}
RECOMP_FUNC void initCutsceneSlotTable(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void insertCutsceneSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF030:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void lookupCutsceneIdMapping(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF1FC:
    ...
    ctx->r4 = ADD32(ctx->r20, 0);
    LOOKUP_FUNC(0x800AEF58)(rdram, ctx);
        goto after_4;
    // 0x800AF200: addu        $a0, $s4, $zero
    ctx->r4 = ADD32(ctx->r20, 0);
    after_4:
...
L_800AFC44:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X128);
;}
RECOMP_FUNC void destroyAllNpcsInSlotChain(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF0D8:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X28);
;}
RECOMP_FUNC void maybeLoadYwingCutscene(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF244:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X28);
;}
RECOMP_FUNC void cinematicShutdownAudioAndAssets(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void bytesDiffer(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF358:
    ...
    ctx->r2 = ADD32(0, 0);
;}
RECOMP_FUNC void cinematicComputeDt(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
RECOMP_FUNC void func_800AF3C0(uint8_t* rdram, recomp_context* ctx) {
    ...
    MEM_W(0X10, ctx->r29) = ctx->r16;
    LOOKUP_FUNC(0x800C6660)(rdram, ctx);
        goto after_0;
    // 0x800AF3D4: sw          $s0, 0x10($sp)
    MEM_W(0X10, ctx->r29) = ctx->r16;
    after_0:
    ...
    LOOKUP_FUNC(0x800B1B58)(rdram, ctx);
        goto after_4;
    // 0x800AF418: nop
    ...
    LOOKUP_FUNC(0x800AF6AC)(rdram, ctx);
        goto after_5;
    // 0x800AF420: nop
    ...
    LOOKUP_FUNC(0x800B07F4)(rdram, ctx);
        goto after_6;
    // 0x800AF428: nop
    ...
    LOOKUP_FUNC(0x800B2520)(rdram, ctx);
        goto after_7;
    // 0x800AF434: nop
...
L_800AF4B8:
    ...
    LOOKUP_FUNC(0x800B1EF4)(rdram, ctx);
        goto after_10;
    // 0x800AF4D0: nop
...
L_800AF520:
    ...
    ctx->r6 = ctx->r6 & 0XFF;
    activateAnimationKeyframe(rdram, ctx);
        goto after_11;
    // 0x800AF528: andi        $a2, $a2, 0xFF
    ctx->r6 = ctx->r6 & 0XFF;
    after_11:
    ...
    ctx->r16 = S32(0X800D << 16);
    LOOKUP_FUNC(0x800B08F4)(rdram, ctx);
        goto after_12;
    // 0x800AF538: lui         $s0, 0x800D
    ctx->r16 = S32(0X800D << 16);
    after_12:
    ...
    LOOKUP_FUNC(0x800B0148)(rdram, ctx);
        goto after_13;
    // 0x800AF540: sw          $zero, -0x2380($s0)
    MEM_W(-0X2380, ctx->r16) = 0;
    after_13:
...
L_800AF608:
    ...
    LOOKUP_FUNC(0x800B0650)(rdram, ctx);
        goto after_19;
    // 0x800AF650: nop
    ...
    ctx->r5 = ADD32(ctx->r16, 0);
    LOOKUP_FUNC(0x800B4168)(rdram, ctx);
        goto after_20;
    // 0x800AF660: addu        $a1, $s0, $zero
    ctx->r5 = ADD32(ctx->r16, 0);
    after_20:
...
L_800AF694:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X20);
;}
RECOMP_FUNC void cinematicInitializer(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    {
    static int s_log = -1;
    ...
    if (s_log) {
        ...
        int n = ++s_count;
        unsigned cineState_pre = (unsigned)MEM_W(0X934, S32(0X800B << 16));
        if (n <= 4 || (n & 63) == 0) {
            extern void rs64_dbg_log4(const char* tag, unsigned a, unsigned b, unsigned c, unsigned d);
            rs64_dbg_log4("cineInit n cineState_pre a0 a1", n, cineState_pre, (unsigned)ctx->r4, (unsigned)ctx->r5);
        }
    }
}
    ...
    LOOKUP_FUNC(0x800AE518)(rdram, ctx);
        goto after_0;
    // 0x800AF45C: swc1        $f0, 0x1EE8($v0)
    MEM_W(0X1EE8, ctx->r2) = ctx->f0.u32l;
    after_0:
...
L_800AF524:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X28);
;}
RECOMP_FUNC void isCinematicActive(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r2 = 0 < ctx->r2 ? 1 : 0;
;}
RECOMP_FUNC void cinematicStageAdvancer(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF604:
    ...
    ctx->r2 = ADD32(0, 0);
;}
RECOMP_FUNC void cinematicDeactivator(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
;}
RECOMP_FUNC void cinematicInterpRatio(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800AF83C:
    ...
    ctx->r5 = ADD32(ctx->r16, 0);
    LOOKUP_FUNC(0x800B3F24)(rdram, ctx);
        goto after_6;
    // 0x800AF88C: addu        $a1, $s0, $zero
    ctx->r5 = ADD32(ctx->r16, 0);
    after_6:
...
L_800AF898:
    ...
    LOOKUP_FUNC(0x800B3FD8)(rdram, ctx);
        goto after_7;
    // 0x800AF89C: addiu       $a0, $sp, 0x40
    ctx->r4 = ADD32(ctx->r29, 0X40);
    after_7:
