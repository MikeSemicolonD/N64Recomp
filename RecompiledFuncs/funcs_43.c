...
RECOMP_FUNC void tickMissionObjectives(uint8_t* rdram, recomp_context* ctx) {
...
L_800FBCDC:
    ...
    LOOKUP_FUNC(0x800C3FEC)(rdram, ctx);
        goto after_2;
    // 0x800FBD04: nop
    ...
    LOOKUP_FUNC(0x800C72E8)(rdram, ctx);
        goto after_3;
    // 0x800FBD0C: nop
    ...
    LOOKUP_FUNC(0x800EFBB4)(rdram, ctx);
        goto after_4;
    // 0x800FBD14: nop
    ...
    LOOKUP_FUNC(0x800ECDDC)(rdram, ctx);
        goto after_5;
    // 0x800FBD1C: nop
...
RECOMP_FUNC void func_800FBDCC(uint8_t* rdram, recomp_context* ctx) {
    ...
    LOOKUP_FUNC(0x800EF1B0)(rdram, ctx);
        goto after_0;
    // 0x800FBDF0: nop
...
RECOMP_FUNC void fake_func_800FBE14(uint8_t* rdram, recomp_context* ctx) {
    ...
    int c1cs = 0;
;}
RECOMP_FUNC void configurePlayerSecondaryWeaponHud(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800FBEA4:
    ...
    loadAndRelocateAsset(rdram, ctx);
        goto after_0;
    // 0x800FBEB8: addiu       $a2, $zero, 0x2000
    ctx->r6 = ADD32(0, 0X2000);
    after_0:
...
L_800FC090:
    ...
    ctx->r4 = ADD32(0, 0);
    LOOKUP_FUNC(0x800B585C)(rdram, ctx);
        goto after_2;
    // 0x800FC0A4: addu        $a0, $zero, $zero
    ctx->r4 = ADD32(0, 0);
    after_2:
...
L_800FCA1C:
    ...
    LOOKUP_FUNC(0x800FC260)(rdram, ctx);
        goto after_3;
    // 0x800FCA34: swc1        $f20, 0x14($sp)
    MEM_W(0X14, ctx->r29) = ctx->f20.u32l;
    after_3:
...
L_800FCE44:
    ...
    LOOKUP_FUNC(0x800FC564)(rdram, ctx);
        goto after_13;
    // 0x800FCE50: addu        $a2, $s3, $zero
    ctx->r6 = ADD32(ctx->r19, 0);
    after_13:
...
L_800FD2F0:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X68);
;}
RECOMP_FUNC void updatePlayerHudFrame(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    LOOKUP_FUNC(0x800AE3BC)(rdram, ctx);
        goto after_1;
    // 0x800FD3AC: nop
...
L_800FE400:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X88);
;}
RECOMP_FUNC void teardownHudInstancesAndUnbindNpcs(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800FEAD0:
    ...
    LOOKUP_FUNC(0x800C713C)(rdram, ctx);
        goto after_13;
    // 0x800FEB48: addiu       $a2, $a2, 0x4
    ctx->r6 = ADD32(ctx->r6, 0X4);
    after_13:
...
L_800FEC70:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X110);
;}
RECOMP_FUNC void refreshPlayerSecondaryWeaponHud(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800FED18:
    ...
    ctx->r4 = ctx->r4 & 0XFF;
    LOOKUP_FUNC(0x800FBE20)(rdram, ctx);
        goto after_0;
    // 0x800FED2C: andi        $a0, $a0, 0xFF
    ctx->r4 = ctx->r4 & 0XFF;
    after_0:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void resetTransientPlayerStateFlags(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800FFA54:
    ...
    CHECK_FR(ctx, 0);
    ctx->f20.fl = ctx->f0.fl;
    LOOKUP_FUNC(0x800B41EC)(rdram, ctx);
        goto after_27;
    // 0x800FFA84: mov.s       $f20, $f0
    CHECK_FR(ctx, 20);
    CHECK_FR(ctx, 0);
...
L_8010077C:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X38);
;}
RECOMP_FUNC void allocateCraftAnimationStateForSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_801008C0:
    ...
    ctx->r4 = ADD32(ctx->r16, 0);
    LOOKUP_FUNC(0x80100594)(rdram, ctx);
        goto after_2;
    // 0x801008D8: addu        $a0, $s0, $zero
    ctx->r4 = ADD32(ctx->r16, 0);
    after_2:
...
L_80100924:
    ...
    LOOKUP_FUNC(0x800FFE00)(rdram, ctx);
        goto after_3;
    // 0x80100928: addu        $a0, $s5, $zero
    ctx->r4 = ADD32(ctx->r21, 0);
    after_3:
...
L_80100EF8:
    ...
    LOOKUP_FUNC(0x801001C8)(rdram, ctx);
        goto after_5;
    // 0x80100F04: nop
    ...
    ctx->r29 = ADD32(ctx->r29, 0X60);
;}
RECOMP_FUNC void freePlayerAuxBuffersIfActive(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80100F98:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void resetCraftAnimationStateForSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80101250:
    ...
    ctx->r4 = ADD32(ctx->r16, 0);
    LOOKUP_FUNC(0x800C7B60)(rdram, ctx);
        goto after_12;
    // 0x80101298: addu        $a0, $s0, $zero
    ctx->r4 = ADD32(ctx->r16, 0);
    after_12:
    ...
    ctx->r5 = ADD32(0, 0X1E);
    LOOKUP_FUNC(0x800C7390)(rdram, ctx);
        goto after_13;
    // 0x801012A8: addiu       $a1, $zero, 0x1E
    ctx->r5 = ADD32(0, 0X1E);
    after_13:
...
L_801018D0:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X28);
;}
RECOMP_FUNC void lv0_runDialogueSequenceA(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X20);
;}
RECOMP_FUNC void lv0_objectiveProgress(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r5 = ADD32(0, 0X6);
    LOOKUP_FUNC(0x800C75C0)(rdram, ctx);
        goto after_0;
    // 0x80101944: addiu       $a1, $zero, 0x6
    ctx->r5 = ADD32(0, 0X6);
    after_0:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void lv0_objectiveSlot1(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    // 0x80101954: jr          $ra
...
RECOMP_FUNC void lv1_initializeObjectTracking(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r29 = ADD32(ctx->r29, 0X28);
;}
RECOMP_FUNC void playVoice2_0xB(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void lv1_playPairedDialogueA(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void playVoice2_0x21C(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void playVoice2_0x04D(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void playVoice2_0x1F8(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void playVoice2_0x22C(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void lv1_playPairedDialogueB(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void lv1_objectiveSlot1(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    // 0x80101BE4: jr          $ra
