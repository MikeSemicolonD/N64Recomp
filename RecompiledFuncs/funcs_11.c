...
L_8004D340:
    ...
    LOOKUP_FUNC(0x800A9E70)(rdram, ctx);
        goto after_0;
    // 0x8004D34C: addiu       $a2, $s2, 0x1C
    ctx->r6 = ADD32(ctx->r18, 0X1C);
    after_0:
...
L_8004D8B4:
    ...
    updateAudioListenerPosFromPlayer(rdram, ctx);
        goto after_11;
    // 0x8004D984: nop
...
L_8004DBA8:
    ...
    ctx->r4 = ADD32(ctx->r18, 0);
    applyPlayerVehicleStateUpdate(rdram, ctx);
        goto after_23;
    // 0x8004DBAC: addu        $a0, $s2, $zero
    ctx->r4 = ADD32(ctx->r18, 0);
    after_23:
...
L_8004E860:
    ...
    ctx->r7 = ADD32(0, 0);
    LOOKUP_FUNC(0x800AA424)(rdram, ctx);
        goto after_35;
    // 0x8004E870: addu        $a3, $zero, $zero
    ctx->r7 = ADD32(0, 0);
    after_35:
...
L_8004EC94:
    ...
    LOOKUP_FUNC(0x800A9FCC)(rdram, ctx);
        goto after_48;
    // 0x8004ECD0: addiu       $a3, $s2, 0x1C
    ctx->r7 = ADD32(ctx->r18, 0X1C);
    after_48:
...
L_8004FF68:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X98);
;}
RECOMP_FUNC void initPlayerVehicleStateTables(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800502A8:
    ...
    LOOKUP_FUNC(0x800BF2F4)(rdram, ctx);
        goto after_2;
    // 0x800502B8: addiu       $s1, $s1, 0x3E0
    ctx->r17 = ADD32(ctx->r17, 0X3E0);
    after_2:
...
L_80053014:
    ...
    LOOKUP_FUNC(0x800C7120)(rdram, ctx);
        goto after_10;
    // 0x800530A8: addiu       $a1, $s1, 0x30
    ctx->r5 = ADD32(ctx->r17, 0X30);
    after_10:
...
RECOMP_FUNC void fake_func_800538AC(uint8_t* rdram, recomp_context* ctx) {
    ...
    int c1cs = 0;
;}
RECOMP_FUNC void trackResourceListWithMappingTables(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80053BC8:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X60);
;}
RECOMP_FUNC void dispatchOverlaySetupByParentAssetName(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80054038:
    ...
    ctx->r5 = ADD32(ctx->r5, 0X28);
    trackResourceListWithMappingTables(rdram, ctx);
        goto after_0;
    // 0x80054054: addiu       $a1, $a1, 0x28
    ctx->r5 = ADD32(ctx->r5, 0X28);
    after_0:
...
L_8005425C:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X38);
;}
RECOMP_FUNC void attachedMeshOverlayNpcHandler(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80054304:
    ...
    ctx->r5 = ADD32(ctx->r18, 0);
    dispatchOverlaySetupByParentAssetName(rdram, ctx);
        goto after_2;
    // 0x8005430C: addu        $a1, $s2, $zero
    ctx->r5 = ADD32(ctx->r18, 0);
    after_2:
...
RECOMP_FUNC void fake_func_80054648(uint8_t* rdram, recomp_context* ctx) {
    ...
    int c1cs = 0;
;}
RECOMP_FUNC void tickWrappingTimerAccumulatorList(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80054794:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X40);
;}
RECOMP_FUNC void loadAssetIntoNewSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_80054984:
    ...
    MEM_W(0X30, ctx->r29) = ctx->r2;
    loadAndDecodeTexture(rdram, ctx);
        goto after_11;
    // 0x800549C0: sw          $v0, 0x30($sp)
    MEM_W(0X30, ctx->r29) = ctx->r2;
    after_11:
