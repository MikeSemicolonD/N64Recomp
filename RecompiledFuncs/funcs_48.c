...
L_80106E64:
    ...
    LOOKUP_FUNC(0x80106E94)(rdram, ctx);
        goto after_19;
    // 0x80106E74: mov.s       $f12, $f22
    CHECK_FR(ctx, 12);
    CHECK_FR(ctx, 22);
...
RECOMP_FUNC void func_8010715C(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r6 = ADD32(0, 0);
    LOOKUP_FUNC(0x800C7978)(rdram, ctx);
        goto after_0;
    // 0x80107178: addu        $a2, $zero, $zero
    ctx->r6 = ADD32(0, 0);
    after_0:
...
RECOMP_FUNC void lvf_checkComplexObjectives(uint8_t* rdram, recomp_context* ctx) {
    ...
    LOOKUP_FUNC(0x800C7514)(rdram, ctx);
        goto after_4;
    // 0x80108094: nop
...
L_80108238:
    ...
    CHECK_FR(ctx, 22);
    ctx->f12.fl = ctx->f22.fl;
    LOOKUP_FUNC(0x80108260)(rdram, ctx);
        goto after_28;
    // 0x8010823C: mov.s       $f12, $f22
    CHECK_FR(ctx, 12);
    CHECK_FR(ctx, 22);
...
RECOMP_FUNC void lvg_checkComplexObjectives(uint8_t* rdram, recomp_context* ctx) {
    ...
    CHECK_FR(ctx, 12);
    ctx->f22.fl = ctx->f12.fl;
    LOOKUP_FUNC(0x800C77A0)(rdram, ctx);
        goto after_0;
    // 0x801084FC: mov.s       $f22, $f12
    CHECK_FR(ctx, 22);
    CHECK_FR(ctx, 12);
...
L_80108A3C:
    ...
    CHECK_FR(ctx, 22);
    ctx->f12.fl = ctx->f22.fl;
    LOOKUP_FUNC(0x80108A70)(rdram, ctx);
        goto after_82;
    // 0x80108A40: mov.s       $f12, $f22
    CHECK_FR(ctx, 12);
    CHECK_FR(ctx, 22);
