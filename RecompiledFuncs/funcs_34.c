...
L_800C44EC:
    ...
    LOOKUP_FUNC(0x800AE814)(rdram, ctx);
        goto after_21;
    // 0x800C4564: swc1        $f0, 0x10($sp)
    MEM_W(0X10, ctx->r29) = ctx->f0.u32l;
    after_21:
...
L_800C4540:
    ...
    LOOKUP_FUNC(0x800C41B0)(rdram, ctx);
        goto after_1;
    // 0x800C4544: addu        $a1, $s0, $zero
    ctx->r5 = ADD32(ctx->r16, 0);
    after_1:
...
L_800C47D0:
    ...
    LOOKUP_FUNC(0x800C723C)(rdram, ctx);
        goto after_7;
    // 0x800C4844: sh          $zero, 0x99C($s2)
    MEM_H(0X99C, ctx->r18) = 0;
    after_7:
...
RECOMP_FUNC void loadControllerModel(uint8_t* rdram, recomp_context* ctx) {
    ...
    LOOKUP_FUNC(0x800C4BF8)(rdram, ctx);
        goto after_3;
    // 0x800C4BDC: nop
    ...
    ctx->r5 = ADD32(0, 0);
    LOOKUP_FUNC(0x800B95D4)(rdram, ctx);
        goto after_4;
    // 0x800C4BE8: addu        $a1, $zero, $zero
    ctx->r5 = ADD32(0, 0);
    after_4:
...
L_800C4CD8:
    ...
    samplePlayerAnimChannel(rdram, ctx);
        goto after_1;
    // 0x800C4D40: addu        $a1, $s1, $zero
    ctx->r5 = ADD32(ctx->r17, 0);
    after_1:
...
L_800C4D5C:
    ...
    ctx->r5 = ADD32(ctx->r17, 0);
    getPlayerSlotFieldAt34(rdram, ctx);
        goto after_3;
    // 0x800C4D60: addu        $a1, $s1, $zero
    ctx->r5 = ADD32(ctx->r17, 0);
    after_3:
...
RECOMP_FUNC void func_800C4DB8(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r16 = ADD32(ctx->r2, 0);
    LOOKUP_FUNC(0x800BC6F0)(rdram, ctx);
        goto after_1;
    // 0x800C4DD4: addu        $s0, $v0, $zero
    ctx->r16 = ADD32(ctx->r2, 0);
    after_1:
...
RECOMP_FUNC void func_800C4DF0(uint8_t* rdram, recomp_context* ctx) {
    ...
    LOOKUP_FUNC(0x800BC834)(rdram, ctx);
        goto after_1;
    // 0x800C4E34: sw          $v0, 0x10($s0)
    MEM_W(0X10, ctx->r16) = ctx->r2;
    after_1:
...
RECOMP_FUNC void func_800C4E6C(uint8_t* rdram, recomp_context* ctx) {
    ...
    applyCheatCodeFromInput(rdram, ctx);
        goto after_0;
    // 0x800C4E80: sb          $zero, 0x10($sp)
    MEM_B(0X10, ctx->r29) = 0;
    after_0:
...
RECOMP_FUNC void func_800C4F38(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r6 = ADD32(0, 0X50);
    LOOKUP_FUNC(0x800C4FF4)(rdram, ctx);
        goto after_1;
    // 0x800C4F6C: addiu       $a2, $zero, 0x50
    ctx->r6 = ADD32(0, 0X50);
    after_1:
    ...
    MEM_W(0X14, ctx->r29) = ctx->f0.u32l;
    LOOKUP_FUNC(0x800B44EC)(rdram, ctx);
        goto after_4;
    // 0x800C4FD0: swc1        $f0, 0x14($sp)
    MEM_W(0X14, ctx->r29) = ctx->f0.u32l;
    after_4:
...
L_800C5200:
    ...
    LOOKUP_FUNC(0x800B4618)(rdram, ctx);
        goto after_2;
    // 0x800C5224: addiu       $a2, $a2, 0x60
    ctx->r6 = ADD32(ctx->r6, 0X60);
    after_2:
...
RECOMP_FUNC void func_800C56C4(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r6 = ADD32(0, 0);
    LOOKUP_FUNC(0x800B883C)(rdram, ctx);
        goto after_0;
    // 0x800C56D4: addu        $a2, $zero, $zero
    ctx->r6 = ADD32(0, 0);
    after_0:
...
L_800C5728:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X20);
;}
RECOMP_FUNC void initSongAssetLoadWorker(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800C5828:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void tickSongAssetLoadWorker(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
RECOMP_FUNC void fake_func_800C5898(uint8_t* rdram, recomp_context* ctx) {
    ...
    int c1cs = 0;
;}
RECOMP_FUNC void menuOverlayInit(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800C5A14:
    ...
    LOOKUP_FUNC(0x800B4020)(rdram, ctx);
        goto after_10;
    // 0x800C5A58: nop
...
L_800C5A84:
    ...
    ctx->r5 = ADD32(0, 0);
    LOOKUP_FUNC(0x800C6854)(rdram, ctx);
        goto after_11;
    // 0x800C5A90: addu        $a1, $zero, $zero
    ctx->r5 = ADD32(0, 0);
    after_11:
...
L_800C5AA8:
    ...
    LOOKUP_FUNC(0x800C6900)(rdram, ctx);
        goto after_12;
    // 0x800C5AB0: nop
...
L_800C5ACC:
    ...
    ctx->r5 = ADD32(0, 0);
    LOOKUP_FUNC(0x800C5D9C)(rdram, ctx);
        goto after_13;
    // 0x800C5AD4: addu        $a1, $zero, $zero
    ctx->r5 = ADD32(0, 0);
    after_13:
...
L_800C5B04:
    ...
    LOOKUP_FUNC(0x800C5EF8)(rdram, ctx);
        goto after_14;
    // 0x800C5B10: addiu       $a1, $a1, 0x7574
    ctx->r5 = ADD32(ctx->r5, 0X7574);
    after_14:
...
L_800C5B40:
    ...
    ctx->r5 = ctx->r20 & 0XFF;
    LOOKUP_FUNC(0x800B47D0)(rdram, ctx);
        goto after_16;
    // 0x800C5B48: andi        $a1, $s4, 0xFF
    ctx->r5 = ctx->r20 & 0XFF;
    after_16:
...
L_800C5C24:
    ...
    ctx->r5 = ctx->r2 & 0XFF;
    LOOKUP_FUNC(0x800C9BF0)(rdram, ctx);
        goto after_18;
    // 0x800C5C38: andi        $a1, $v0, 0xFF
    ctx->r5 = ctx->r2 & 0XFF;
    after_18:
...
L_800C5C44:
    ...
    ctx->r7 = ctx->r20 & 0XFF;
    LOOKUP_FUNC(0x800BF830)(rdram, ctx);
        goto after_19;
    // 0x800C5C58: andi        $a3, $s4, 0xFF
    ctx->r7 = ctx->r20 & 0XFF;
    after_19:
...
L_800C5C64:
    ...
    ctx->r4 = ADD32(0, 0);
    LOOKUP_FUNC(0x800C131C)(rdram, ctx);
        goto after_20;
    // 0x800C5C68: addu        $a0, $zero, $zero
    ctx->r4 = ADD32(0, 0);
    after_20:
...
L_800C5C98:
    ...
    ctx->r4 = ADD32(0, 0);
    LOOKUP_FUNC(0x800C28F0)(rdram, ctx);
        goto after_21;
    // 0x800C5C9C: addu        $a0, $zero, $zero
    ctx->r4 = ADD32(0, 0);
    after_21:
...
L_800C5CC0:
    ...
    ctx->r4 = ADD32(0, 0);
    LOOKUP_FUNC(0x800C30C8)(rdram, ctx);
        goto after_23;
    // 0x800C5CC4: addu        $a0, $zero, $zero
    ctx->r4 = ADD32(0, 0);
    after_23:
...
L_800C5E84:
    ...
    ctx->r6 = ADD32(ctx->r6, -0X1);
    LOOKUP_FUNC(0x800AEC60)(rdram, ctx);
        goto after_0;
    // 0x800C5E98: addiu       $a2, $a2, -0x1
    ctx->r6 = ADD32(ctx->r6, -0X1);
    after_0:
...
L_800C5EA4:
    ...
    LOOKUP_FUNC(0x800AF3C0)(rdram, ctx);
        goto after_1;
    // 0x800C5EA8: nop
    ...
    LOOKUP_FUNC(0x800B24C4)(rdram, ctx);
        goto after_2;
    // 0x800C5EBC: nop
...
L_800C6038:
    ...
    ctx->r21 = S32(0X800A << 16);
    LOOKUP_FUNC(0x800C6720)(rdram, ctx);
        goto after_4;
    // 0x800C6060: lui         $s5, 0x800A
    ctx->r21 = S32(0X800A << 16);
    after_4:
...
L_800C6074:
    ...
    LOOKUP_FUNC(0x800C435C)(rdram, ctx);
        goto after_1;
    // 0x800C6088: addiu       $a1, $a1, -0x10
    ctx->r5 = ADD32(ctx->r5, -0X10);
    after_1:
...
L_800C619C:
    ...
    LOOKUP_FUNC(0x800C7268)(rdram, ctx);
        goto after_5;
    // 0x800C61A0: addiu       $a0, $s0, 0x8AC
    ctx->r4 = ADD32(ctx->r16, 0X8AC);
    after_5:
    ...
    LOOKUP_FUNC(0x800C722C)(rdram, ctx);
        goto after_6;
    // 0x800C61D0: nop
    ...
    LOOKUP_FUNC(0x800FEECC)(rdram, ctx);
        goto after_7;
    // 0x800C61EC: nop
    ...
    LOOKUP_FUNC(0x800FEEF4)(rdram, ctx);
        goto after_8;
    // 0x800C6200: nop
...
L_800C6228:
    ...
    LOOKUP_FUNC(0x800C4D8C)(rdram, ctx);
        goto after_9;
    // 0x800C6248: swc1        $f20, 0x10($sp)
    MEM_W(0X10, ctx->r29) = ctx->f20.u32l;
    after_9:
    ...
    LOOKUP_FUNC(0x800C5580)(rdram, ctx);
        goto after_10;
    // 0x800C625C: addiu       $a2, $s2, 0xC
    ctx->r6 = ADD32(ctx->r18, 0XC);
    after_10:
    ...
    ctx->r5 = ADD32(ctx->r18, 0);
    LOOKUP_FUNC(0x800C5918)(rdram, ctx);
        goto after_11;
    // 0x800C6280: addu        $a1, $s2, $zero
    ctx->r5 = ADD32(ctx->r18, 0);
    after_11:
    ...
    ctx->r5 = ADD32(ctx->r18, 0);
    LOOKUP_FUNC(0x800C51E0)(rdram, ctx);
        goto after_12;
    // 0x800C628C: addu        $a1, $s2, $zero
    ctx->r5 = ADD32(ctx->r18, 0);
    after_12:
