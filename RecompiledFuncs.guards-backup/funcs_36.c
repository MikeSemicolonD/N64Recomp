...
;}
RECOMP_FUNC void func_800C7738(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800C7760:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void func_800C776C(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
RECOMP_FUNC void addTimerHandleWrapper(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void func_800C7884(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800C7CDC:
    ...
    ctx->r29 = ADD32(ctx->r29, 0X38);
;}
RECOMP_FUNC void func_800C7CEC(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
RECOMP_FUNC void func_800C7D44(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void func_800C7D60(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
RECOMP_FUNC void func_800C7D7C(uint8_t* rdram, recomp_context* ctx) {
    ...
    ctx->r29 = ADD32(ctx->r29, 0X18);
;}
RECOMP_FUNC void func_800C7D98(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_800C8FFC:
    ...
    if (S32(ctx->r4) != 0) { lo = S32(S64(S32(ctx->r3)) / S64(S32(ctx->r4))); hi = S32(S64(S32(ctx->r3)) % S64(S32(ctx->r4))); } else { lo = 0; hi = S32(ctx->r3); }
...
L_800C9354:
    ...
    if (S32(ctx->r3) != 0) { lo = S32(S64(S32(ctx->r7)) / S64(S32(ctx->r3))); hi = S32(S64(S32(ctx->r7)) % S64(S32(ctx->r3))); } else { lo = 0; hi = S32(ctx->r7); }
...
L_800C9394:
    ...
    if (S32(ctx->r4) != 0) { lo = S32(S64(S32(ctx->r7)) / S64(S32(ctx->r4))); hi = S32(S64(S32(ctx->r7)) % S64(S32(ctx->r4))); } else { lo = 0; hi = S32(ctx->r7); }
